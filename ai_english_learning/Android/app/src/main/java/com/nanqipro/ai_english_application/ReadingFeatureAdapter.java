...
public class ReadingFeatureAdapter extends RecyclerView.Adapter<ReadingFeatureAdapter.ViewHolder> {

    private List<ReadingFragment.ReadingFeature> features;
    private OnItemClickListener onItemClickListener;

    public interface OnItemClickListener {
        void onItemClick(ReadingFragment.ReadingFeature feature);
    }

    public ReadingFeatureAdapter(List<ReadingFragment.ReadingFeature> features) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_reading_feature, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ReadingFragment.ReadingFeature feature = features.get(position);
