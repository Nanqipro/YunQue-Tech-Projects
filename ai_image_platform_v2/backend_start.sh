...
# 主函数
main() {
    print_info "=== AI图像处理平台 v2.0 后端启动脚本 ==="
    ...
    if check_port 5002; then
        print_warning "端口 5002 已被占用，后端服务可能无法启动"
        print_info "请停止占用端口 5002 的进程或修改配置"
    fi
